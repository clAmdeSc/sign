...
model_path = r'C:/Users/sarga/Downloads/kmeans_model.pkl'
with open(model_path, 'rb') as file:
    kmeans = pickle.load(file)
print(f"KMeans model loaded from {model_path}")

test_folder=r'C:/Users/sarga/Downloads/SignLang/Code/Bag of Features/ISL Datasets/Train-Test/Test'
...
import csv
loc=r'C:\Users\sarga\Downloads\SignLang\Code\Bag of Features\cnn files/test.csv'
